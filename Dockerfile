...
RUN conda install --quiet --yes conda==24.11.1 pip python=3.9.18 \
    ...
    && conda install --quiet --yes --channel bioconda tmalign  \
...
script=$1\n\
shift\n\
python /app/alphafold/${script} "$@"' > /app/run_alphafold.sh \
